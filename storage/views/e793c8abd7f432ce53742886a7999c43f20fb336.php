...
<figure class="FofUpload-TextPreview" data-loading="false" data-expanded="false" data-hassnippet="{@has_snippet}">
    ...
    <div class="FofUpload-TextPreviewSnippet">
      <pre><code data-preview-text="<?php echo($translator->trans('fof-upload.forum.text_preview.no_snippet_preview')) ?>" data-nosnippet-text="<?php echo($translator->trans('fof-upload.forum.text_preview.no_snippet')) ?>">{@snippet}</code></pre>
    </div>
    ...
    <button type="button" class="Button hasIcon FofUpload-TextPreviewToggle">
        ...
        <span class="Button-label FofUpload-TextPreviewExpand">
            <?php echo($translator->trans('fof-upload.forum.text_preview.expand')); ?>
        </span>
        ...
        <span class="Button-label FofUpload-TextPreviewCollapse">
            <?php echo($translator->trans('fof-upload.forum.text_preview.collapse')); ?>
        </span>
    ...
    <div class="FofUpload-TextPreviewError">
        <p>
            ...
            <?php echo($translator->trans('fof-upload.forum.text_preview.error')) ?>
        </p>
    </div>
...
<?php /**PATH C:\laragon\www\teachingPlatform\vendor\fof\upload/resources/templates/text-preview.blade.php ENDPATH**/ ?>