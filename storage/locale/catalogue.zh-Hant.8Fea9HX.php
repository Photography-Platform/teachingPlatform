...
',
    ...
    'core.forum.index_sort.newest_button' => '最近主題',
...
',
    ...
    'flarum-nicknames.admin.permissions.edit_own_nickname_label' => '更改個人暱稱',
    'flarum-nicknames.admin.settings.max_label' => '最大暱稱長度',
    'flarum-nicknames.admin.settings.min_label' => '最小暱稱長度',
    'flarum-nicknames.admin.settings.random_username_help' => '註冊時隱藏「會員名稱」輸入框，自動生成隨機數字組成的會員名。並顯示必填「暱稱」輸入框。此設置僅在開啟「註冊時允許設置暱稱」時生效。',
    'flarum-nicknames.admin.settings.random_username_label' => '隨機會員名稱',
    'flarum-nicknames.admin.settings.regex_label' => '驗證用正則表達式',
    'flarum-nicknames.admin.settings.set_on_registration_label' => '註冊時允許設置暱稱',
    'flarum-nicknames.admin.settings.unique_label' => '需要唯一暱稱',
    'flarum-nicknames.admin.wrong_driver' => '您必須在 <a><strong>常規設置</strong></a> 中將「暱稱」設置為外顯名稱，此擴展才會起作用。',
    'flarum-nicknames.api.invalid_nickname_message' => '無效暱稱。請聯繫論壇管理員獲取暱稱規則。',
    ...
    'flarum-nicknames.forum.edit_user.nicknames_text' => '暱稱',
    ...
    'flarum-nicknames.ref.change_nickname' => '更改暱稱',
    'flarum-nicknames.ref.nickname' => '暱稱',
...
',
    ...
    'fof-upload.admin.help_texts.client_extension' => '默認情況下，上傳器將根據 MIME 類型選擇一個安全的文件擴展名。
對於某些基於 ZIP 或二進制數據的文件類型，這可能導致使用不正確的通用擴展名。
在這裡，您可以輸入一個逗號分隔的文件擴展名列表，該列表將被逐字保留。
',
    'fof-upload.admin.help_texts.composer_buttons' => '默認情況下，媒體管理按鈕和上傳按鈕皆可見。您可以選擇只顯示其中一個按鈕。
',
    'fof-upload.admin.help_texts.disable-download-logging' => '開啟此設定可查看下載量及未來可能的統計數據。
',
    'fof-upload.admin.help_texts.disable-hotlink-protection' => '熱鏈保護可防止從其他站點下載。目前的方式需求 csrf token 及帖文 ID。
',
    'fof-upload.admin.help_texts.download_templates' => '下載模板是上載的檔案如何在論壇上顯示 比如預覽、按鈕等，目前支援的有：
',
    'fof-upload.admin.help_texts.mime_types' => '請於此設定對映。每一個 MIME 類型的正規表示式都將由指定的上載接口處理。
',
    'fof-upload.admin.help_texts.resize' => '您可以選擇是否在上載圖片前調整圖片大小，您也可以設定圖片最大長寬（px），圖片大小調整將會保持圖片長寬比例。
',
    'fof-upload.admin.help_texts.s3_acl' => '應用於上傳對象的 ACL（默認：私有）。 有關可能的值，請參閱 https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl
',
    'fof-upload.admin.help_texts.s3_compatible_storage' => '僅在使用 S3 兼容存儲時才需要以下設置。 如果您使用 AWS，您可以將它們留空。
',
    'fof-upload.admin.help_texts.s3_instance_profile' => '公鑰和秘鑰留空時，可為實例單獨配置。
',
    'fof-upload.admin.help_texts.watermark' => '在圖片上載時新增水印，僅支援非 gif 圖片。
',
    'fof-upload.admin.inspect-mime.description' => '由於 PHP Fileinfo 擴展在不同服務器上返回的文件類型會有所不同，因此 FoF Upload 僅將其作為備用選項。
一般情況下，均使用 <a>PHP Mime Detector</a> 庫檢測 MIME 類型。
',
    'fof-upload.admin.inspect-mime.guessed-extension' => '默認文件擴展名',
    'fof-upload.admin.inspect-mime.laravel-validation' => 'Laravel 文件驗證消息',
    'fof-upload.admin.inspect-mime.mime-detector' => 'Mime 檢測器（主）',
    'fof-upload.admin.inspect-mime.mime-fileinfo' => 'PHP Fileinfo（備）',
    'fof-upload.admin.inspect-mime.no-file-selected' => '請選擇文件',
    'fof-upload.admin.inspect-mime.not-available' => '暫無結果',
    'fof-upload.admin.inspect-mime.select' => '選擇一個文件，並檢測類型。您選擇的文件不會被保存。',
    'fof-upload.admin.inspect-mime.title' => '檢查 MIME',
    'fof-upload.admin.inspect-mime.validation-failed' => '失敗：{error}',
    'fof-upload.admin.inspect-mime.validation-passed' => '通過',
    'fof-upload.admin.labels.aws-s3.acl' => '訪問控制列表（ACL）',
    'fof-upload.admin.labels.aws-s3.advanced_title' => '高級 S3 存儲設置',
    'fof-upload.admin.labels.aws-s3.bucket' => '存儲空間（Bucket）',
    'fof-upload.admin.labels.aws-s3.endpoint' => '訪問域名（Endpoint）',
    'fof-upload.admin.labels.aws-s3.key' => 'Key',
    'fof-upload.admin.labels.aws-s3.region' => '區域',
    'fof-upload.admin.labels.aws-s3.secret' => 'Secret',
    'fof-upload.admin.labels.aws-s3.title' => 'AWS S3 存儲設定',
    'fof-upload.admin.labels.aws-s3.use_path_style_endpoint' => '使用 path-style 訪問域名',
    'fof-upload.admin.labels.client_extension.title' => '用戶自定義文件擴展名',
    'fof-upload.admin.labels.composer_buttons.options.both' => '全部顯示',
    'fof-upload.admin.labels.composer_buttons.options.media-btn' => '僅媒體管理按鈕',
    'fof-upload.admin.labels.composer_buttons.options.upload-btn' => '僅上傳按鈕',
    'fof-upload.admin.labels.composer_buttons.title' => '編輯器按鈕',
    'fof-upload.admin.labels.disable-download-logging.title' => '停用下載日誌',
    'fof-upload.admin.labels.disable-download-logging.toggle' => '停用',
    'fof-upload.admin.labels.disable-hotlink-protection.title' => '停用熱鏈保護',
    'fof-upload.admin.labels.disable-hotlink-protection.toggle' => '停用',
    'fof-upload.admin.labels.imgur.client_id' => 'Imgur 用戶端 ID',
    'fof-upload.admin.labels.imgur.title' => 'Imgur 圖片存儲設定',
    'fof-upload.admin.labels.imgur.tos' => '你有義務確保你的用戶遵守 Imgur 的 <a>服務條款</a>',
    'fof-upload.admin.labels.inspect-mime' => '測試文件 MIME 類型',
    'fof-upload.admin.labels.local.cdn_url' => 'CDN 連結 (在檔案前)',
    'fof-upload.admin.labels.local.title' => '本地存儲設定',
    'fof-upload.admin.labels.preferences.max_file_size' => '最大檔案大小 (單位 KB)',
    'fof-upload.admin.labels.preferences.mime_types' => '設定 MIME 類型以及上載接口',
    'fof-upload.admin.labels.preferences.php_ini_values' => '當前服務器 <code>php.ini</code> 配置上限為 <code>post_max_size={post}</code>，<code>upload_max_filesize={upload}</code>。請確保上方設置的值小於上限，否則請提高上限。若您使用 <code>Nginx</code> 服務器，請確保 <code>client_max_body_size</code> 高於當前設置的值。',
    'fof-upload.admin.labels.preferences.title' => '偏好設定',
    ...
    'fof-upload.admin.labels.qiniu.title' => '七牛存儲設定',
    'fof-upload.admin.labels.resize.max_width' => '最大圖片寬度',
    'fof-upload.admin.labels.resize.title' => '圖片縮放',
    'fof-upload.admin.labels.resize.toggle' => '縮放圖片',
    'fof-upload.admin.labels.watermark.file' => '上載水印圖片',
    'fof-upload.admin.labels.watermark.position' => '水印位置',
    'fof-upload.admin.labels.watermark.title' => '圖片水印',
    'fof-upload.admin.labels.watermark.toggle' => '圖片水印',
    'fof-upload.admin.pane.description' => '設置上傳服務和首選項。',
    'fof-upload.admin.pane.title' => '上傳',
    'fof-upload.admin.permissions.delete_uploads_of_others_label' => '刪除用戶上傳的文件',
    'fof-upload.admin.permissions.download_label' => '下載檔案',
    'fof-upload.admin.permissions.upload_label' => '上載檔案',
    'fof-upload.admin.permissions.view_user_uploads_label' => '查看用戶上傳的文件',
    'fof-upload.admin.templates.bbcode-image' => 'BBCode 圖片預覽模板',
    'fof-upload.admin.templates.bbcode-image_description' => '使用 BBCode 在行內完整顯示圖片。<strong>此模板依賴於 flarum/bbcode 擴展程序。</strong>無下載、統計和熱鏈保護功能。
',
    'fof-upload.admin.templates.file' => '預設檔案下載模板',
    'fof-upload.admin.templates.file_description' => '顯示檔案名稱及基本信息，經由 php 代理下載，支援統計及熱鏈保護。
',
    'fof-upload.admin.templates.image' => '預設圖片下載模板',
    'fof-upload.admin.templates.image-preview' => '完整圖片預覽模板',
    'fof-upload.admin.templates.image-preview_description' => '於行內顯示完整圖片。不支援下載、統計及熱鏈保護。
',
    'fof-upload.admin.templates.image_description' => '顯示圖片縮略圖並經由 php 代理下載，支援統計及熱鏈保護。
',
    'fof-upload.admin.templates.just-url' => '僅鏈接',
    'fof-upload.admin.templates.just-url_description' => '僅插入 URL。渲染可以由具有自動鏈接功能的其他插件處理。沒有下載功能，沒有統計功能，且沒有熱鏈保護。
',
    'fof-upload.admin.templates.markdown-image' => 'Markdown 圖片預覽模板',
    'fof-upload.admin.templates.markdown-image_description' => '使用 Markdown 格式在行內完整顯示圖片。<strong>此模板依賴於 flarum/markdown 擴展程序。</strong>無下載、統計和熱鏈保護功能。
',
    'fof-upload.admin.templates.text-preview' => '本文預覽',
    'fof-upload.admin.templates.text-preview_description' => '顯示本文的前 5 行預覽，附帶展開全文按鈕。
',
    'fof-upload.admin.upload_methods.aws-s3' => '亞馬遜 S3',
    ...
    'fof-upload.api.upload_errors.cannot_write_to_disk' => '無法寫入磁盤。',
    'fof-upload.api.upload_errors.could_not_detect_mime' => '無法偵測這個檔案的 MIME 類型，請重新嘗試。',
    'fof-upload.api.upload_errors.forbidden_type' => '不允許上載這個類型的檔案。',
    'fof-upload.api.upload_errors.max_upload_file_size_form' => '上傳表單已達到最大文件大小限制。',
    'fof-upload.api.upload_errors.max_upload_file_size_ini' => '已達到 php.ini 上傳最大文件大小限制。',
    'fof-upload.api.upload_errors.no_file_uploaded' => '沒有上傳文件。',
    'fof-upload.api.upload_errors.no_files_made_it_to_upload' => '請上傳不超過 {max} kb 的文件。',
    'fof-upload.api.upload_errors.no_upload_tmp_folder' => '沒有用於上傳文件的 tmp 文件夾。',
    'fof-upload.api.upload_errors.partial_upload' => '部分上傳。',
    'fof-upload.api.upload_errors.unsupported_type' => '上載適配器不支援這個 MIME 類型： {mime}。',
    'fof-upload.api.upload_errors.upload_blocked_by_php_extension' => 'php 擴展阻止了上傳。',
    'fof-upload.forum.buttons.attach' => '上載',
    'fof-upload.forum.buttons.cancel' => '取消',
    'fof-upload.forum.buttons.media' => '我的文件',
    'fof-upload.forum.buttons.upload' => '上傳',
    'fof-upload.forum.buttons.user_uploads' => '用戶上傳',
    'fof-upload.forum.file_list.confirm_selection_btn' => '{fileCount, plural, =0 {未選擇} one {嵌入} other {嵌入所選文件}}',
    'fof-upload.forum.file_list.empty' => '沒有可展示的文件。',
    'fof-upload.forum.file_list.hide_file.btn_a11y_label' => '在文件管理器中隱藏「{fileName}」',
    'fof-upload.forum.file_list.hide_file.hide_confirmation' => '確定要隱藏「{fileName}」嗎？文件只會從你的文件管理器中消失，並不會影響已嵌入文件的帖子。',
    'fof-upload.forum.file_list.hide_file.hide_fail' => '無法隱藏文件「{fileName}」',
    'fof-upload.forum.file_list.hide_file.hide_success' => '文件隱藏',
    'fof-upload.forum.file_list.hide_file.loading' => '正在隱藏文件……',
    'fof-upload.forum.file_list.load_more_files_btn' => '加載更多',
    'fof-upload.forum.file_list.loading' => '加載文件中……',
    'fof-upload.forum.file_list.modal_empty_desktop' => '你還沒有上傳過文件。點擊按鈕或拖拽文件到這裡開始上傳吧。',
    'fof-upload.forum.file_list.modal_empty_phone' => '你還沒有上傳過文件。點擊上方按鈕開始上傳吧。',
    'fof-upload.forum.file_list.release_to_upload' => '鬆開鼠標上傳',
    'fof-upload.forum.file_list.select_file_a11y_label' => '選擇文件「{fileName}」',
    'fof-upload.forum.media_manager' => '媒體管理器',
    'fof-upload.forum.states.error' => '錯誤',
    'fof-upload.forum.states.loading' => '正在上載',
    'fof-upload.forum.states.unauthorized' => '您未被允許下載檔案',
    'fof-upload.forum.text_preview.collapse' => '收起全文',
    'fof-upload.forum.text_preview.error' => '文件預覽無法加載。此文件可能已被刪除，或文件 ID已失效。
',
    'fof-upload.forum.text_preview.expand' => '展開全文',
    'fof-upload.forum.text_preview.no_snippet' => '<暫無可用的預覽代碼片段>',
    'fof-upload.forum.text_preview.no_snippet_preview' => '<本文的預覽將會在此處展示>',
    'fof-upload.forum.validation.max_size' => '文件需小於 {max} KB。',
    'jeromegillard-map.admin.settings.mapbox.help' => '在 <a>mapbox.com</a> 免費註冊以獲取令牌。請尊重他們的<b>版權</b>。',
    'jeromegillard-map.admin.settings.mapbox.label' => 'Mapbox key',
    'jeromegillard-map.admin.settings.maptiler.help' => '在 <a>maptiler.com</a> 免費註冊以獲取令牌。 請尊重他們的<b>版權</b>。',
    'jeromegillard-map.admin.settings.maptiler.label' => 'MapTiler token',
    'jeromegillard-map.admin.settings.osm.help' => 'OpenStreetMap tiles 非常適合對地圖進行編程，但如果您打算在生產中使用 tiles，請閱讀 OpenStreetMap 的<a>Tile Usage Policy</a>。',
    'jeromegillard-map.admin.settings.style.help' => '選擇地圖樣式。 <a>查看他們的風格</a>。',
    'jeromegillard-map.admin.settings.style.label' => '{provider} 預設樣式',
    'jeromegillard-map.admin.settings.thunderforest.help' => '在 <a>thunderforest.com</a> 免費註冊以獲取 API 密鑰。請尊重他們的<b>使用條款</b>。',
    'jeromegillard-map.admin.settings.thunderforest.label' => 'Thunderforest API key',
    'jeromegillard-map.admin.settings.tiles_provider.help' => '選擇出現在背景中的 tiles layer 提供者',
    'jeromegillard-map.admin.settings.tiles_provider.label' => '默認圖層提供者',
    'jeromegillard-map.admin.settings.zoom.help' => '從 0 到 18 的任何整數。',
    'jeromegillard-map.admin.settings.zoom.label' => '預設縮放比例',
    'jeromegillard-map.admin.templates.file_description' => '在 flarum 中顯示地圖。原始文件將可供下載。提供者和样式將是在擴展程序設置中定義的。 <b>您必須安裝並啟用 flarum/bbcode 才能運行</b>。',
    'jeromegillard-map.admin.templates.map' => '地圖',
    'jeromegillard-map.forum.text_editor.bbcode_tooltip' => '插入地圖',
    'jeromegillard-map.forum.text_editor.location_placeholder' => '何處',
    'jeromegillard-map.forum.text_editor.marker_description_placeholder' => '標記彈出內容。 將主旨及文本都留空以隱藏標記。',
    'jeromegillard-map.forum.text_editor.marker_title_placeholder' => '標記標題',
...
',
    ...
    'blomstra-gdpr.lib.data.uploads.export_description' => 'All files uploaded by the user.',
    'blomstra-gdpr.lib.data.uploads.anonymize_description' => 'Removes the user reference from the uploaded files. The files themselves remain accessible to users that could view them pre-anonymization.',
    'blomstra-gdpr.lib.data.uploads.delete_description' => 'Deletes all files uploaded by the user.',
...
',
    ...
    'jeromegillard-map.admin.templates.map' => 'Map',
    'jeromegillard-map.admin.templates.file_description' => 'Display a map in flarum. The original file will be available to download. The tiles provider and style will be the one defined in the extension\'s settings. <b>You must have flarum/bbcode installed and enabled for this to work</b>.',
    'jeromegillard-map.admin.settings.tiles_provider.label' => 'Default tiles layer provider',
    'jeromegillard-map.admin.settings.tiles_provider.help' => 'Select the provider of the tiles layer that appears in the background',
    'jeromegillard-map.admin.settings.zoom.label' => 'Default zoom level',
    'jeromegillard-map.admin.settings.zoom.help' => 'Any integer from 0 to 18.',
    'jeromegillard-map.admin.settings.style.label' => 'Default style for {provider}',
    'jeromegillard-map.admin.settings.style.help' => 'Pick a map style. <a>Take a look to their styles</a>.',
    'jeromegillard-map.admin.settings.maptiler.label' => 'MapTiler token',
    'jeromegillard-map.admin.settings.maptiler.help' => 'Register for free at <a>maptiler.com</a> to get a token. Please respect their <b>copyrights</b>.',
    'jeromegillard-map.admin.settings.osm.help' => 'OpenStreetMap tiles are fine for programming your map, but read the <a>Tile Usage Policy</a> of OpenStreetMap if you’re going to use the tiles in production.',
    'jeromegillard-map.admin.settings.mapbox.label' => 'Mapbox key',
    'jeromegillard-map.admin.settings.mapbox.help' => 'Register for free at <a>mapbox.com</a> to get a token. Please respect their <b>copyrights</b>.',
    'jeromegillard-map.admin.settings.thunderforest.label' => 'Thunderforest API key',
    'jeromegillard-map.admin.settings.thunderforest.help' => 'Register for free at <a>thunderforest.com</a> to get an API key. Please respect their <b>terms of usage</b>.',
    'jeromegillard-map.forum.text_editor.bbcode_tooltip' => 'insert a map',
    'jeromegillard-map.forum.text_editor.location_placeholder' => 'WHERE',
    'jeromegillard-map.forum.text_editor.marker_title_placeholder' => 'Marker title',
    'jeromegillard-map.forum.text_editor.marker_description_placeholder' => 'Marker pop-up content. Leave title and desc both empty to hide the marker.',
